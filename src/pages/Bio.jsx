...
const Bio = () => {
  ...
  return (
    ...
    >
      ...
      {/* Navigation Bar */}
      <Box
        bg="rgba(10, 0, 2, 0.7)" // Deep Black with transparency
        py={2}
        px={{ base: 4, md: 8 }}
        position="absolute"
        top={0}
        ...
        _hover={{ boxShadow: '0 0 20px rgba(255, 69, 0, 0.3)', transition: 'all 0.3s' }}
      >
        <HStack justify="space-between" color="white">
          <Text
            fontSize="xl"
            fontWeight="bold"
            _hover={{ transform: 'scale(1.1)', color: neonGlow, transition: 'all 0.3s' }}
          >
            🏟️
          </Text>
          <HStack spacing={6} fontWeight="medium">
            <Text
              _hover={{ color: 'white', transform: 'scale(1.05)', boxShadow: '0 2px 10px rgba(255, 69, 0, 0.3)', transition: 'all 0.3s' }}
              textTransform="uppercase"
            >
              Club
            </Text>
